...
const MENU = [
  {id:'about',      icon:'about',      route:null, title:L('ҚМДБ туралы','О ҚМДБ'),               sub:L('Тарихы, миссиясы және қызмет бағыттары','История, миссия и направления деятельности')},
  {id:'leadership', icon:'leadership', route:null, title:L('Басшылық','Руководство'),             sub:L('Бас мүфти және ҚМДБ басшылығы','Верховный муфтий и руководство ДУМК')},
  {id:'structure',  icon:'structure',  route:null, title:L('Құрылым','Структура'),                sub:L('Басқармалар, бөлімдер және секторлар','Управления, отделы и секторы')},
  {id:'building',   icon:'building',   route:null, title:L('Ғимарат','Здание'),                   sub:L('Қабаттар, кабинеттер және залдар','Этажи, кабинеты и залы')},
  {id:'map',        icon:'map',        route:'./map.html', primary:true,
                                                          title:L('Мешіттер картасы','Карта мечетей'), sub:L('Қазақстан мешіттері мен діни оқу орындары','Мечети и религиозные учебные заведения Казахстана')},
  {id:'orgs',       icon:'orgs',       route:null, title:L('Қарасты мекемелер','Подведомственные учреждения'), sub:L('Оқу орындары, қорлар және ұйымдар','Учебные заведения, фонды и организации')},
  {id:'digital',    icon:'digital',    route:null, title:L('Цифрлық жобалар','Цифровые проекты'), sub:L('Қосымшалар, сайттар және онлайн платформалар','Приложения, сайты и онлайн-платформы')},
  {id:'munara',     icon:'tv',         route:null, title:L('Munara TV','Munara TV'),              sub:L('Тікелей эфир және медиа жобалар','Прямой эфир и медиапроекты')}
];
